...
# sbatch -J zt3 --partition gpu train.sh --f1_variant linear --zero_theta 3
# sbatch -J zt4 --partition gpu train.sh --f1_variant linear --zero_theta 4
# sbatch -J zt5 --partition gpu train.sh --f1_variant linear --zero_theta 5
# sbatch -J zt6 --partition gpu train.sh --f1_variant linear --zero_theta 6
# sbatch -J zt12 --partition gpu train.sh --f1_variant linear --zero_theta 1 2
# sbatch -J zt34 --partition gpu train.sh --f1_variant linear --zero_theta 3 4
# sbatch -J zt56 --partition gpu train.sh --f1_variant linear --zero_theta 5 6
# sbatch -J ztall --partition gpu train.sh --f1_variant linear --zero_theta 1 2 3 4 5 6
...
# sbatch -J l1_3 --partition gpu train.s--f1_variant linear h --l1_reg --l1_coeff 0.3 --version 16095
