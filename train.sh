...
python -u find_minima.py --total_steps 300000 --swa_steps 50000 --version $version --slurm_id $SLURM_JOB_ID "$@" --f1_variant linear --f2_variant mlp 
python -u run_swag.py --total_steps 300000 --swa_steps 50000 --version $version --slurm_id $SLURM_JOB_ID "$@" --f1_variant linear --f2_variant mlp
# python -u find_minima.py --total_steps 300000 --swa_steps 50000 --version $version --slurm_id $SLURM_JOB_ID "$@" --f1_variant linear --f2_variant pysr_residual
...
# python -u sr.py --version 250 --target f2 --seed 0 #--time_in_hours 0.1 --max_size 60
