...
Commands that reproduce the figures from already-run experiments are in `official_plots.sh` and takes 5-15 minutes (some of the evaluations are computed from scratch the first time this command is run.)
