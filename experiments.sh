...
python -u find_minima.py --version 0 --total_steps $steps --l1_reg weights --l1_coeff 2
python -u find_minima.py --version 1 --total_steps $steps --load_f1_f2 0 --prune_f1_topk 2

# run symbolic regression to distill phi into equations. we ran with 32 cores for 8 hours
python sr.py --nn_version 1 --version 1 --target f2 --time_in_hours $sr_time

# run pure sr w/ learned psi. we ran with 32 cores for 8 hours
python pure_sr.py --version 2 --loss_fn ll --time_in_hours $sr_time
...
python sr.py --target f2_direct --version 3 --nn_version 28114 --loss_fn ll --time_in_hours $sr_time

# train mse optimized variants of the models
python -u find_minima.py --version 2 --total_steps $steps --load_f1_f2 1 --mse_loss
python sr.py --nn_version 1 --version 4 --target f2_direct --loss_fn mse --time_in_hours $sr_time
python pure_sr.py --version 5 --loss_fn mse --time_in_hours $sr_time
python sr.py --target f2_direct --version 6 --nn_version 28114 --loss_fn mse --time_in_hours $sr_time

# topk comparisons. uses nn versions 3, 4, 5, 13, 14, 15 and sr versions 13, 14, 15
for k in {3..5}; do
    python -u find_minima.py --version $k --total_steps $steps --l1_reg weights --l1_coeff 2 --mse_loss
    python -u find_minima.py --version $((10+k)) --total_steps $steps --load_f1_f2 $k --prune_f1_topk $k --mse_loss
    python sr.py --nn_version $((10+k)) --version $((10+k)) --target f2 --time_in_hours $sr_time
...
python -u find_minima.py --version 6 --total_steps $steps --f2_variant linear --load_f1 2 --l1_reg f2_weights --l1_coeff 2 --mse_loss
for k in 0 2 5 10 20; do
    python -u find_minima.py --version $((20+k)) --total_steps $steps --f2_variant linear --load_f1_f2 6  --prune_f2_topk 2 --mse_loss
...
sr_c=$(python calc_rmse.py --eval_type pysr --dataset all --version 1 --pysr_version 1)
python calc_rmse.py --eval_type petit --dataset all
puresr_c=$(python calc_rmse.py --eval_type pure_sr --dataset all --pysr_version 2)
puresr2_c=$(python calc_rmse.py --eval_type pysr --dataset all --version 28114 --pysr_version 3)
# mse versions
python calc_rmse.py --eval_type nn --dataset all --version 2
sr_mse_c=$(python calc_rmse.py --eval_type pysr --dataset all --version 1 --pysr_version 4)
puresr_mse_c=$(python calc_rmse.py --eval_type pure_sr --dataset all --pysr_version 5)
puresr2_mse_c=$(python calc_rmse.py --eval_type pysr --dataset all --version 28114 --pysr_version 6)
...
python five_planet.py --version 1 --pysr_version 1 --pysr_model_selection $sr_c --N $N --turbo --extrapolate
python five_planet.py --pure_sr --pysr_version 2 --pysr_model_selection $puresr_c --N $N --turbo --extrapolate
python five_planet.py --version 28114 --pysr_version 3 --pysr_model_selection $puresr2_c --N $N --turbo --extrapolate

# create the five planet plots
python five_planet_plot.py --version_json ../model_versions.json --N $N
