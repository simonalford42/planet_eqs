...
def parse():
    ...
    parser.add_argument('--f1_variant', type=str, default='linear',
                        choices=['zero', 'identity', 'pysr', 'pysr_frozen', 'random_features', 'linear', 'mean_cov', 'mlp', 'random', 'random_frozen', 'bimt', 'biolinear'])
    ...
    parser.add_argument('--f2_variant', type=str, default='mlp', choices=['pysr', 'pysr_residual', 'ifthen', 'mlp', 'linear', 'bimt'])
